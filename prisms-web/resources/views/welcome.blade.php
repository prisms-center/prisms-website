                ...
                <div class="rounded-lg shadow-md bg-white ring-1 ring-black ring-opacity-5 overflow-hidden">
                    ...
                    <div class="pt-5 pb-6">
                        <div class="px-2 space-y-1">
                            <a href="#" class="block px-3 py-2 rounded-md text-base font-medium text-gray-900 hover:bg-gray-50">Science</a>

                            <a href="#" class="block px-3 py-2 rounded-md text-base font-medium text-gray-900 hover:bg-gray-50">Software</a>

                            <a href="#" class="block px-3 py-2 rounded-md text-base font-medium text-gray-900 hover:bg-gray-50">Materials Commons</a>
...
{{--                        </div>--}}
        ...
        <main class="bg-gray-900 min-h-screen">
            <div class="pt-10 bg-gray-900x sm:pt-16 lg:pt-8 lg:pb-14 lg:overflow-hidden">
                        ...
                        <div class="mx-auto max-w-md px-4 sm:max-w-2xl sm:px-6 sm:text-center lg:px-0 lg:text-left lg:flex lg:items-center">
                            <div class="lg:py-24">
                                <a href="#" class="inline-flex items-center text-white bg-black rounded-full p-1 pr-2 sm:text-base lg:text-sm xl:text-base hover:text-gray-200">
                                    <span class="px-3 py-0.5 text-white text-xs font-semibold leading-5 uppercase tracking-wide bg-indigo-500 rounded-full">Need Data Management?</span>
                                    <span class="ml-4 text-sm">Explore Materials Commons</span>
                                ...
                                <h1 class="mt-4 text-4xl tracking-tight font-extrabold text-white sm:mt-5 sm:text-6xl lg:mt-6 xl:text-6xl">
                                    <span class="block">Integrated Codes</span>
                                    <span class="block text-indigo-400">Science Drives Us!</span>
                                </h1>
                                    ...
                                    <form action="#" class="sm:max-w-xl sm:mx-auto lg:mx-0">
                                        <div class="sm:flex">
                                            ...
                                            <div class="mt-3 sm:mt-0 sm:ml-3">
                                                <button type="submit" class="block w-full py-3 px-4 rounded-md shadow bg-indigo-500 text-white font-medium hover:bg-indigo-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-300 focus:ring-offset-gray-900">Contact Us</button>
                                            </div>
                                        </div>
                                        <p class="mt-3 text-sm text-gray-300 sm:mt-4">Looking to collaborate? Drop us an email telling us what you are looking for, and we'll reach out!</p>
                                    </form>
                                </div>
                            </div>
                        </div>
