<x-app-layout>
    ...
    <div class="py-16 bg-gray-50 overflow-hidden lg:py-24">
        <div class="relative max-w-xl mx-auto px-4 sm:px-6 lg:px-8 lg:max-w-7xl">
            ...
            <div class="relative">
                <h2 class="text-center text-3xl leading-8 font-extrabold tracking-tight text-gray-900 sm:text-4xl">PRISMS Multi-scale Framework</h2>
            ...
            <div class="relative mt-12 lg:mt-24 lg:grid lg:grid-cols-2 lg:gap-8 lg:items-center">
                <div class="relative">
                    <h3 class="text-2xl font-extrabold text-gray-900 tracking-tight sm:text-3xl">PRISMS Integrated Software Framework</h3>
                    ...
                    <dl class="mt-10 space-y-10">
                        <div class="relative">
                            <dt>
                                ...
                                <p class="ml-16 text-lg leading-6 font-medium text-gray-900">DFT-FE: Real Space Kohn-Sham DFT Theory Code</p>
                            </dt>
                            <dd class="mt-2 ml-16 text-base text-gray-500">
                                Our Finite Element (FEM) based real-space numerical framework scales to tens of thousand of atoms, providing a
                                first principles' framework for determining relevant material properties.
                            </dd>
                        </div>
                        ...
                        <div class="relative">
                            <dt>
                                ...
                                <p class="ml-16 text-lg leading-6 font-medium text-gray-900">CASM: Statistical Mechanics Code</p>
                            </dt>
                            <dd class="mt-2 ml-16 text-base text-gray-500">
                                CASM, which stands for Clusters Approach to Statistical Mechanics, is the PRISMS statistical mechanics software.
                            </dd>
                        </div>
                        ...
                        <div class="relative">
                            <dt>
                                ...
                                <p class="ml-16 text-lg leading-6 font-medium text-gray-900">PRISMS-PF: Phase Field Modeling Code</p>
                            </dt>
                            <dd class="mt-2 ml-16 text-base text-gray-500">
                                PRISMS-PF is a massively scalable phase field framework based on the deal.ii finite element library. PRISMS-PF
                                provides a flexible platform for solving a wide range of partial differential equations.
                            </dd>
                        </div>
                        ...
                        <div class="relative">
                            <dt>
                                ...
                                <p class="ml-16 text-lg leading-6 font-medium text-gray-900">PRISMS-Plasticity: Continuum and Crystal Plasticity Codes</p>
                            </dt>
                            <dd class="mt-2 ml-16 text-base text-gray-500">
                                PRISMS-Plasticity is an open source parallel continuum and 3-D CPFE package. It supports both rate-dependent and
                                rate independent crystal plasticity algorithms.
                            </dd>
                        </div>
                    </dl>
                </div>
                ...
                <div class="mt-10 -mx-4 relative lg:mt-0" aria-hidden="true">
                    ...
                    <img class="relative mx-auto" width="590" src="{{URL::asset('/images/prisms-framework.png')}}" alt="">
                </div>
            </div>
